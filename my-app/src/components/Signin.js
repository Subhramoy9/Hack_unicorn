...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', backgroundColor: '#f5f5f5' }}>
      <div style={{ width: '400px', padding: '20px', background: '#ffffff', borderRadius: '8px', boxShadow: '0px 2px 4px rgba(0, 0, 0, 0.1)' }}>
        <div style={{ marginBottom: '20px' }}>
          <button onClick={connectWallet} style={{ border: '1px solid', padding: '10px 20px' }}>
            {walletAddress && walletAddress.length > 0 ? `Connected: ${walletAddress.slice(0, 7)}....` : 'Connect Wallet'}
          </button>
        </div>
        <button onClick={verify} style={{ border: '1px solid', padding: '10px 20px' }}>
          Login
        </button>
      </div>
    </div>
